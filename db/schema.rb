...
ActiveRecord::Schema.define(version: 20150413230502) do
  ...
  create_table "fd_entregas", force: true do |t|
  ...
  add_index "fd_entregas", ["fd_pedido_id"], name: "index_fd_entregas_on_fd_pedido_id", using: :btree
  ...
  create_table "fd_itempedidos", force: true do |t|
    ...
    t.boolean  "flag_itemalterado"
    t.boolean  "flag_itemadicional"
    t.boolean  "flag_exibido"
  end
