Food::Application.routes.draw do
  ...
  match '/salva_observacao', to: 'fd_itempedidos#salva_observacao', via: 'get'
  ...
  match '/busca_itemcomanda_adicionais', to: 'fd_itempedidos#busca_itemcomanda_adicionais', via: 'get'
  ...
  match '/busca_itemMisto', to: 'fd_itensprodutos#busca_itemMisto', via: 'get'
  match '/insere_ingredientealterado', to: 'fd_itemalterados#insere_ingredientealterado', via: 'get'
  match '/insere_ingredientealteradoMisto', to: 'fd_itemalterados#insere_ingredientealteradoMisto', via: 'get'
  ...
  match '/busca_caixa_aberto', to: 'fd_caixas#busca_caixa_aberto', via: 'get'
