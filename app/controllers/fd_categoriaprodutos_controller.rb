class FdCategoriaprodutosController < ApplicationController
  ...
  def buscaCategoriaProdutos
    fd_categoriaprodutos = FdCategoriaproduto.where(:father_id => params[:father_id], :flag_global => false)
  ...
  private
    ...
    def fd_categoriaproduto_params
      params.require(:fd_categoriaproduto).permit(:desc_categoria, :father_id, :flag_global)
    end
end
